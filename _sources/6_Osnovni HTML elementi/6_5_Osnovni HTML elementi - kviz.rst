...
.. quizq::
    ...
    .. fillintheblank:: osnovni_html_elementi_kviz_5

        Посматрај табелу на наредној слици, па одговори на питање.

        .. image:: ../../_images/osnovni_html_elementi_kviz_5.png
            :width: 400
            :align: center
        
        Колико најмање HTML елемената *td* је потребно да се опише приказана табела? 
